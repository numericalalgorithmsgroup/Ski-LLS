...
//
  ...
  * info = 0;
  ...
  // Modifications for Skills project:
  // DGEQPF has been deprecated and it might not be present
  // in certain LAPACK distributions, skip this threshold
#if 0
  ...
  if( num_factorized_fixed_cols < mn_A ) {
    * info = NoFLA_HQRRP_WY_blk_var4_INT( 
